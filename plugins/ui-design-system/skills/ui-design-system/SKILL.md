...
If the user mentions a real product by name in conversation ("make it feel like Linear", "Stripe-style fintech"), prefer **curated mode** — the vendored catalog has 74 grounded references and is almost always a better starting point than improvising.
...
74 vendored real-world design systems live under [design-systems/](design-systems/). See [design-systems/INDEX.md](design-systems/INDEX.md) for the categorized list. Use them as references in curated mode (`ui-design-system: like linear`) or as fallback inspiration in guided mode question 7.
